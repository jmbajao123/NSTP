...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $co_id = $_SESSION['co_id']; // Assuming the coordinator ID is stored in the session
    ...
    $check_sql = "SELECT * FROM coordinator WHERE co_id = '$co_id'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql = "INSERT INTO coordinator (co_id, birthdate, age, gender, civil_status, address, profile_picture, valid_id) 
                VALUES ('$co_id', '$birthdate', '$age', '$gender', '$civil_status', '$address', '$profile_picture_name', '$valid_id_name')";
    }
