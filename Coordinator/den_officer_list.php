...
<head>
  ...
  <title>Denied Officer Account - STII CWTS CLEANING ATTENDANCE</title>
...
<?php include 'Include/sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Denied Officer Account</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
          <li class="breadcrumb-item">Denied Officer Account</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
              	<div class="col-lg-12">
              		<h5 class="card-title">Denied Officer Account
...
<?php else: ?>
    <tr>
        <td colspan="5" style="text-align: center;">No Denied Officer Account found</td>
    </tr>
<?php endif; ?>
