...
<div class="col-lg-4">
    ...
    <input type="text" name="email" id="email" placeholder="Input the Email" class="form-control" required>
</div>
<div class="col-lg-4">
	<center>
        <label for="password"><h4>Password</h4></label>
    </center>
    <input type="password" name="password" id="password" placeholder="Input the Password" class="form-control" required>
</div>
<div class="col-lg-4">
	<center>
        <label for="confirm_password"><h4>Confirm Password</h4></label>
    </center>
    <input type="password" name="confirm_password" id="confirm_password" placeholder="Input the Confirm Password" class="form-control" required>
</div>
<script>
