...
<head>
  ...
  <title>Course Assign List - STII CWTS CLEANING ATTENDANCE</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Course Assign</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
              	<div class="col-lg-2">
              		<h5 class="card-title">Course Assign List</h5>
              	</div>
              ...
              <table class="table table-bordered border-primary">
                ...
                <tbody>
					...
					$sql = "SELECT DISTINCT c.course_name, ta.status
					        FROM t_assign ta
