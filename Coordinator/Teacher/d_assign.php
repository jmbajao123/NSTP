...
<head>
  ...
  <title>Department Assign List - STII CWTS CLEANING ATTENDANCE</title>
...
<?php include 'Include/sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Department Assign</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
          <li class="breadcrumb-item">Department Assign</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
              	<div class="col-lg-2">
              		<h5 class="card-title">Department Assign List</h5>
              	</div>
              ...
              <table class="table table-bordered border-primary">
                ...
                <tbody>
					...
					// Fetch department names, course names, and status for the logged-in t_id
					$sql = "SELECT DISTINCT d.department_name, ta.status
					        FROM t_assign ta
