...
<head>
  ...
  <title>Approved Officer Account - STII CWTS CLEANING ATTENDANCE</title>
...
<?php include 'Include/sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Approved Officer Account</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
          <li class="breadcrumb-item">Approved Officer Account</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
              	<div class="col-lg-12">
              		<h5 class="card-title">Approved Officer Account
...
<?php if (mysqli_num_rows($result) > 0): ?>
    <?php while ($row = mysqli_fetch_assoc($result)): ?>
        <tr>
            ...
            <td>
              <a href="off_info.php" class="btn btn-outline-success">More</a>
            </td>
        </tr>
    <?php endwhile; ?>
<?php else: ?>
    <tr>
        <td colspan="5" style="text-align: center;">No Approved Officer Account found</td>
    </tr>
<?php endif; ?>
