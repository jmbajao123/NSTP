            ...
            <div class="card-body">
              <div class="row">
              	<div class="col-lg-12">
                    ...
                    <a href="add_a_area.php" style="float: right;" class="btn btn-outline-primary">
                      Add Assign Area
                    </a>
                  </h5><br>
              	</div><br>
...
// Check if co_id is set
if (!isset($_SESSION['co_id'])) {
    echo "<tr><td colspan='3' class='text-center'><center>Error: User not signed in.</center></td></tr>";
    exit();
}

$co_id = $_SESSION['co_id']; // Get the currently signed-in user's co_id

$sql = "SELECT area_id, area_name, status FROM area WHERE co_id = ?";
...
if ($result->num_rows > 0):
    while ($row = $result->fetch_assoc()): ?>
        <tr>
            ...
            <td>
                <a href="a_info.php?area_id=<?php echo $row['area_id']; ?>" class="btn btn-outline-primary">More</a>
            </td>
        </tr>
    <?php endwhile;
else: ?>
