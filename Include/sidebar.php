<div id="sidebar" class='active'>
            <div class="sidebar-wrapper active">
			        <center><br>
			        	<img src="assets/images/s.png" alt="" srcset="" height="100">
			        </center>
			        ...
			        <ul class="menu">
			                ...
			                <!-- <li class="sidebar-item  has-sub">
			                    <a href="#" class='sidebar-link'>
			                        ...
			                        <span>Assign Cleaning Area</span>
			                    </a>
			                    
			                    <ul class="submenu ">
			                        
			                        <li>
			                            <a href="ass_c_a.php">Assign Cleaning Area</a>
			                        </li>
			                        
			                        <li>
			                            <a href="#">Cleaning Area Completed</a>
			                        </li>
